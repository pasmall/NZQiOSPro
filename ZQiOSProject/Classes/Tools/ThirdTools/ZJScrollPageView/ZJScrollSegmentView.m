...
// 遮盖
@property (strong, nonatomic) UIImageView *coverLayer;
// 滚动scrollView
...
static CGFloat const xGap = 22.5;
    ...
    [UIView animateWithDuration:animatedTime animations:^{
        ...
        if (weakSelf.coverLayer) {
            if (weakSelf.segmentStyle.isScrollTitle) {
                ...
                if (self.segmentStyle.isAdjustCoverOrLineWidth) {
                    CGFloat coverW = [self.titleWidths[self.currentIndex] floatValue] + wGap;
        ...
        [weakSelf adjustTitleOffSetToCurrentIndex:self.currentIndex];
...
- (UIImageView *)coverLayer {
    ...
    if (_coverLayer == nil) {
        ...
        coverView.image = [UIImage imageNamed:@"cinct_113"];
